...
public class DrivetrainSubsystem extends SubsystemBase {
	...
	private final AHRS m_navx = new AHRS(SerialPort.Port.kMXP/* , (byte) 200 */); // NavX connected over MXP
	...
	public DrivetrainSubsystem() {
		...
		odometry = new SwerveDriveOdometry(m_kinematics, m_navx.getRotation2d());
	}
	...
	public void zeroGyroscope() {
		...
		odometry.resetPosition(calculatedPose, m_navx.getRotation2d());
	}
	...
	public void periodic() {
		...
		calculatedPose = odometry.update(m_navx.getRotation2d(), states);
		...
		gyroPose = new Pose2d(new Translation2d(m_navx.getDisplacementX(), m_navx.getDisplacementY()), m_navx.getRotation2d());
		tab.add("Gyro X", gyroPose.getX());
		tab.add("Gyro Y", gyroPose.getY());

		tab.add("Rotation Method", getGyroscopeRotation().getDegrees());
	}
}
